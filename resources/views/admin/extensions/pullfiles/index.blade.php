...
<?php 
    ...
    $EXTENSION_ID = "pullfiles";
    $EXTENSION_NAME = stripslashes("Pull Files");
    $EXTENSION_VERSION = "1.2.0";
    $EXTENSION_DESCRIPTION = stripslashes("Pull Files allows you to download files on your pterodactyl panel.");
    $EXTENSION_ICON = "/assets/extensions/pullfiles/icon.jpg";
...
@section('content')
  ...
  $nonceIdentifier = 'dd0107f82c8ac23ea0bbcffc62cc155e23929b6e66ac2d12172a4083cb8e0b46';
  $nonceIdentifierWithoutReplacement = '%%__NONCE' . '__%%';
?>

<div class="row">
  <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
    <div class="box {{ $version !== 'Unknown' ? $version !== "1.2.0" ? 'box-danger' : 'box-primary' : 'box-primary' }}">
      <div class="box-header with-border">
        <h3 class="box-title"><i class='bx bx-git-repo-forked' ></i> Information</h3>
      </div>
      <div class="box-body">
        <p>
          Thank you for purchasing <b>Pull Files</b>! You are currently using version <code>1.2.0</code> (latest version is <code>{{ $version }}</code>).
  ...
  <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
    <div class="box">
      ...
      <div class="box-body">
        <img src="/extensions/pullfiles/pullfiles_banner.jpg" class="img-rounded img-responsive" alt="Banner" style="max-width: 600px; margin: 0 auto;">
      </div>
    </div>
  </div>
</div>
